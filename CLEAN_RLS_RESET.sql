-- Clean RLS Reset - Drop All Policies and Recreate Simple Ones
-- This script completely resets all RLS policies to avoid conflicts
...
DROP POLICY IF EXISTS "Project owners can view team members" ON public.team_members;
