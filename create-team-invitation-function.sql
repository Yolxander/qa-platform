-- Simple script to create the missing create_team_invitation function
...
DROP FUNCTION IF EXISTS public.create_team_invitation(TEXT, TEXT, UUID, UUID, TEXT, TEXT);

-- =============================================
-- 2. CREATE THE FUNCTION WITH EXACT PARAMETERS
-- =============================================
