-- Fix create_team_invitation function
-- This script creates the missing function that's causing the 404 error
...
-- =============================================
-- 2. CREATE THE MAIN FUNCTION (5 parameters)
-- =============================================
...
-- =============================================
-- 3. LEGACY FUNCTION REMOVED
-- =============================================

-- The legacy 4-parameter function has been removed to prevent conflicts.
-- Only the 5-parameter function is kept, which properly handles team-specific invitations.

-- =============================================
-- 4. GRANT PERMISSIONS
-- =============================================

-- Grant execute permissions on the single function version
...
-- Check that the single function exists
SELECT 
    routine_name, 
    routine_type,
    specific_name,
