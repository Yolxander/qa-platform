...
-- This schema creates teams connected to projects and team members connected to profiles
...
COMMENT ON COLUMN public.team_members.role IS 'Role of the team member: owner, admin, or member';
