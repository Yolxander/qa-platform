-- Add team_id column to existing team_invitations table
-- This migration script adds the team_id column and updates the function
-- Run this in your Supabase SQL Editor

-- =============================================
-- 1. ADD TEAM_ID COLUMN TO EXISTING TABLE
-- =============================================
...
-- If you have existing invitations, you might want to set a default team
...
-- =============================================
-- 4. UPDATE THE FUNCTION TO INCLUDE TEAM_ID
-- =============================================
...
-- =============================================
-- 5. UPDATE ACCEPT INVITATION FUNCTION
-- =============================================
