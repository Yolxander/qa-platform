...
-- =============================================
-- This script will create all necessary tables and fix the project creation error
...
-- Projects policies (CRITICAL FOR PROJECT CREATION)
...
-- This query will show you all the tables that were created
SELECT table_name 
FROM information_schema.tables 
WHERE table_schema = 'public' 
AND table_name IN ('profiles', 'projects', 'bugs', 'todos', 'teams', 'team_members')
ORDER BY table_name;
