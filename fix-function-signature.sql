-- Fix the function signature to match what the application expects
-- The error shows it's looking for: invite_email, invite_name, invite_role, project_id_param
...
-- =============================================
-- 2. CREATE FUNCTION WITH CORRECT SIGNATURE
-- =============================================

-- Create function with the signature the error message suggests
