...
-- This script sets up all the necessary database functions and policies
-- for handling teams where users are members but not owners
...
WHERE schemaname = 'public' 
  AND tablename IN ('team_members', 'teams', 'projects');
